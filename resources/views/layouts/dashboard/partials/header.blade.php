    ...
    <div class="with-vertical"><!-- ---------------------------------- -->
        ...
        <nav class="navbar navbar-expand-lg p-0">
                                        ...
                                        <div class="col-8">
                                            <a class="fw-semibold text-dark d-flex align-items-center lh-1 text-decoration-none"
                                                href="#"><iconify-icon icon="solar:question-circle-line-duotone"
                                                    class="fs-6 me-2"></iconify-icon>Frequently Asked Questions</a>
                                        </div>
                                        <div class="col-4">
            ...
            <div class="d-block d-lg-none">
                <img src="{{ asset('assets/images/logos/logo.png') }}" class="dark-logo" alt="Logo-Dark" />
                                ...
                                <div class="message-body" data-simplebar>
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <div class="w-100 d-inline-block v-middle ps-3">
                                            ...
                                            <span class="fs-2 text-nowrap d-block fw-normal mt-1 text-muted">Salma sent
                                                you new
                                                message</span>
                                        </div>
                                    </a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item d-none d-xl-block">
                    <a href="index.html" class="text-nowrap nav-link">
                        <img src="{{ asset('assets/images/logos/logo.png') }}" class="dark-logo" width="180"
                            alt="" />
                        <img src="{{ asset('assets/images/logos/logo.png') }}" class="light-logo" width="180"
                            alt="" />
                    </a>
                </li>
            </ul>
